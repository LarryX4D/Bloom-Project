...
TitleBarLabel.Text = "____|BLOOM PROJECT|____"
...
Announce_Label.Text = loadstring(game:HttpGet("https://raw.githubusercontent.com/LarryX4D/Bloom-Project/main/announce"))()
...
Credits_Label.Text = "Made by: paradox  \nDiscord: xparadoxz\nVersion: "..version
...
local function UpdateTarget(player)
	pcall(function()
		if table.find(ForceWhitelist,player.UserId) then
			SendNotify("Bloom Project","You cant target this player: @"..player.Name.." / "..player.DisplayName,5)
			player = nil
		end
	end)
	if (player ~= nil) then
...
CMDBar.FocusLost:Connect(function()
	...
	SendNotify("Bloom Project",("Executed "..command),5)
	CMDBar.Text = ""
end)
...
WalkSpeed_Button.MouseButton1Click:Connect(function()
	pcall(function()
		...
		SendNotify("Bloom Project","Walk speed updated.",5)
	end)
end)
...
JumpPower_Button.MouseButton1Click:Connect(function()
	pcall(function()
		...
		SendNotify("Bloom Project","Jump power updated.",5)
	end)
end)
...
FlySpeed_Button.MouseButton1Click:Connect(function()
	pcall(function()
		...
		SendNotify("Bloom Project","Fly speed updated.",5)
	end)
end)
...
SaveCheckpoint_Button.MouseButton1Click:Connect(function()
	...
	SendNotify("Bloom Project","Checkpoint saved.",5)
end)

ClearCheckpoint_Button.MouseButton1Click:Connect(function()
	SavedCheckpoint = nil
	SendNotify("Bloom Project","Checkpoint cleared.",5)
end)
...
WhitelistTarget_Button.MouseButton1Click:Connect(function()
	if TargetedPlayer ~= nil then
		if table.find(ScriptWhitelist, Players[TargetedPlayer].UserId) then
			...
			SendNotify("Bloom Project",TargetedPlayer.." removed from whitelist.",5)
		else
			table.insert(ScriptWhitelist, Players[TargetedPlayer].UserId)
			SendNotify("Bloom Project",TargetedPlayer.." added to whitelist.", 5)
		end
	end
end)
...
AntiFling_Button.MouseButton1Click:Connect(function()
	...
	if AntiFling_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		...
		loadstring(game:HttpGet('https://raw.githubusercontent.com/LarryX4D/Bloom-Project/main/Antifling.lua'))()
	else
		_G.AntiFlingToggled = false
	end
end)
...
Day_Button.MouseButton1Click:Connect(function()
	if Shaders_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(255,0,0) then
		...
		SendNotify("Bloom Project","Please turn off shaders.",5)
	end
end)
...
FreeEmotes_Button.MouseButton1Click:Connect(function()
	if not FreeEmotesEnabled then
		...
		SendNotify("Bloom Project","Loading free emotes.\nCredits: Gi#7331")
		loadstring(game:HttpGet("https://raw.githubusercontent.com/LarryX4D/Bloom-Project/main/Emotes.lua"))()
	end
end)
...
Players.PlayerRemoving:Connect(function(player)
	pcall(function()
		if player.Name == TargetedPlayer then
			UpdateTarget(nil)
			SendNotify("Bloom Project","Targeted player left/rejoined.",5)
		end
	end)
end)
...
plr.CharacterAdded:Connect(function(x)
	...
	if PotionDi_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(PotionDi_Button)
		SendNotify("Bloom Project","PotionDick was automatically disabled due to your character respawn",5)
	end
	if PotionFling_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(PotionFling_Button)
		SendNotify("Bloom Project","PotionFling was automatically disabled due to your character respawn",5)
	end
	if AntiRagdoll_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(AntiRagdoll_Button)
		SendNotify("Bloom Project","AntiRagdoll was automatically disabled due to your character respawn",5)
	end
	if SpamMines_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(SpamMines_Button)
		SendNotify("Bloom Project","SpamMines was automatically disabled due to your character respawn",5)
	end
	if Fly_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(Fly_Button)
		flying = false
		...
		KeyDownFunction:Disconnect()
		KeyUpFunction:Disconnect()
		SendNotify("Bloom Project","Fly was automatically disabled due to your character respawn",5)
	end
	...
	if ammount == original_ammount then
		...
		if not (count == original_ammount) then
			SysBroker:Destroy()
			SendNotify("Bloom Project","An unexpected error occurred, re-joining...")
			game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, game.JobId, plr)
		end
	else
		SysBroker:Destroy()
	...
	while task.wait(10) do
		pcall(function()
			...
			if version<GuiVersion then
				SendNotify("Bloom Project","You are not using the latest version, please run the script again.",5)
				task.wait(5)
				SysBroker:Destroy()
				game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, game.JobId, plr)
			end
...
SendNotify("Bloom Project","Gui developed by paradox - Discord in your clipboard",10)
setclipboard("https://discord.gg/8zrF7xNHMU")
loadstring(game:HttpGet("https://raw.githubusercontent.com/LarryX4D/Bloom-Project/main/Premium.lua"))() -- load the premium
